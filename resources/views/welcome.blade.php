<x-marketing-layout>
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div class="lg:col-span-6 space-y-8 text-left relative z-10">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-900 leading-tight">
                    ...
                    <span class="bg-gradient-to-r from-emerald-500 via-emerald-600 to-teal-500 bg-clip-text text-transparent">On Autopilot</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="{{ url('/features') }}" class="inline-flex items-center justify-center px-6 py-4 rounded-xl bg-white hover:bg-slate-100 text-slate-700 font-bold text-sm tracking-wide border border-slate-200 transition duration-150 shadow-sm">
                        Explore Features
                    </a>
                </div>
                ...
                <div class="pt-6 border-t border-slate-200/60 space-y-3">
                    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest block">Are you a player? Download companion app</span>
                    <div class="flex flex-wrap items-center gap-3">
                        <a href="#" class="group transition duration-200">
                            <div class="bg-slate-900 text-white hover:bg-slate-800 border border-slate-800 flex items-center gap-2 px-3.5 py-2 rounded-xl shadow-sm">
            ...
            <div class="lg:col-span-6 relative">
                ...
                <!-- Mockup Box -->
                <div class="relative bg-white border border-slate-200 rounded-2xl shadow-2xl p-6 overflow-hidden">
                    <!-- Top bar -->
                    <div class="flex items-center justify-between border-b border-slate-200/60 pb-4 mb-6">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-[11px] font-semibold text-slate-450 ml-2">turf-dashboard.io/scheduler</span>
                        </div>
                        <span class="text-[10px] font-bold px-2 py-0.5 rounded bg-emerald-50 text-emerald-600 border border-emerald-200/50">LIVE VENUE MONITOR</span>
                    </div>

                    <!-- mini metrics grids -->
                    <div class="grid grid-cols-3 gap-4 mb-6">
                        <div class="p-3 bg-slate-50 border border-slate-200/50 rounded-xl">
                            <span class="text-[9px] font-semibold text-slate-400 uppercase">Today's Sales</span>
                            <span class="block text-sm font-black text-slate-800 mt-0.5">$1,840.00</span>
                        ...
                        <div class="p-3 bg-slate-50 border border-slate-200/50 rounded-xl">
                            ...
                            <span class="block text-sm font-black text-slate-800 mt-0.5">88.5%</span>
                        ...
                        <div class="p-3 bg-slate-50 border border-slate-200/50 rounded-xl">
                            ...
                            <span class="block text-sm font-black text-slate-800 mt-0.5">26 Slots</span>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
                            <span class="text-xs font-bold text-slate-800">Active Slots Scheduler - Pitch A</span>
                            <span class="text-[10px] font-bold text-slate-400">August 04, 2026</span>
                        </div>
                        
                        <div class="space-y-2 text-xs">
                            <!-- Slot 1: Booked -->
                            <div class="flex items-center gap-3 p-2 bg-emerald-500/10 border border-emerald-500/20 rounded-xl">
                                <span class="font-bold text-emerald-600 min-w-[70px] text-[10px]">04:00 - 05:00 PM</span>
                                <div class="flex-grow flex items-center justify-between">
                                    <span class="font-bold text-slate-800">Barcelona Football Club Academy</span>
                            ...
                            <!-- Slot 2: Locked -->
                            <div class="flex items-center gap-3 p-2 bg-indigo-500/5 border border-indigo-500/15 rounded-xl">
                                <span class="font-bold text-indigo-500 min-w-[70px] text-[10px]">05:00 - 06:00 PM</span>
                                <div class="flex-grow flex items-center justify-between">
                                    <span class="font-bold text-slate-800">Locked Slot: Elite League Practice</span>
                            ...
                            <!-- Slot 3: Available -->
                            <div class="flex items-center gap-3 p-2 bg-slate-50 border border-slate-200/50 rounded-xl">
                                <span class="font-bold text-slate-400 min-w-[70px] text-[10px]">06:00 - 07:00 PM</span>
                                <div class="flex-grow flex items-center justify-between">
                                    <span class="text-slate-450">Unbooked Slot - Peak Pricing ($60/hr)</span>
                                    <span class="text-[9px] px-2 py-0.5 rounded-full bg-slate-200 text-slate-600 font-bold uppercase tracking-wider">Available</span>
                                </div>
                            </div>
                            <!-- Slot 4: Booked -->
                            <div class="flex items-center gap-3 p-2 bg-amber-500/10 border border-amber-500/20 rounded-xl">
                                <span class="font-bold text-amber-600 min-w-[70px] text-[10px]">07:00 - 08:00 PM</span>
                                <div class="flex-grow flex items-center justify-between">
                                    <span class="font-bold text-slate-800">Local Corporates Match</span>
    ...
    <section class="py-16 bg-white border-y border-slate-200/80 transition duration-300">
        <div class="max-w-7xl mx-auto px-6">
            <p class="text-center text-xs font-bold text-slate-400 uppercase tracking-widest mb-10">TRUSTED BY TOP VENUES NATIONWIDE</p>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div>
                    <span class="block text-4xl font-black text-slate-900 bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">500,000+</span>
                    <span class="text-xs font-bold text-slate-500 mt-2 block">Slots Booked Online</span>
                </div>
                <div>
                    <span class="block text-4xl font-black text-slate-900 bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">300+</span>
                    <span class="text-xs font-bold text-slate-500 mt-2 block">Active Venues & Arenas</span>
                </div>
                <div>
                    <span class="block text-4xl font-black text-slate-900 bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">$12M+</span>
                    <span class="text-xs font-bold text-slate-500 mt-2 block">Revenue Processed</span>
                </div>
                <div>
                    <span class="block text-4xl font-black text-slate-900 bg-gradient-to-r from-emerald-500 to-teal-500 bg-clip-text text-transparent">99.99%</span>
                    <span class="text-xs font-bold text-slate-500 mt-2 block">System Uptime Guarantee</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 lg:py-32">
        <div class="max-w-7xl mx-auto px-6 space-y-16">
            ...
            <div class="text-center max-w-3xl mx-auto space-y-4">
                <span class="text-xs font-bold text-emerald-500 uppercase tracking-widest">Built For Sports Businesses</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-8 hover:border-slate-350 hover:shadow-md transition duration-300 space-y-6">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-lg font-bold text-slate-900">Visual Scheduling Grid</h3>
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-8 hover:border-slate-350 hover:shadow-md transition duration-300 space-y-6">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-lg font-bold text-slate-900">Dynamic Pricing Engine</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-8 hover:border-slate-350 hover:shadow-md transition duration-300 space-y-6">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-lg font-bold text-slate-900">Staff Management Control</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-8 hover:border-slate-350 hover:shadow-md transition duration-300 space-y-6">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-lg font-bold text-slate-900">Discount & Coupon Matrix</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-8 hover:border-slate-350 hover:shadow-md transition duration-300 space-y-6">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-lg font-bold text-slate-900">Equipment & Add-on Rentals</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-8 hover:border-slate-350 hover:shadow-md transition duration-300 space-y-6">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-lg font-bold text-slate-900">CSV & PDF Accounting Exports</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
    ...
    <section class="py-24 bg-gradient-to-b from-slate-100 to-white transition duration-300">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div class="lg:col-span-5 order-2 lg:order-1 relative">
                ...
                <div class="relative max-w-[280px] mx-auto bg-black border-[8px] border-slate-900 rounded-[40px] shadow-2xl aspect-[9/19.5] overflow-hidden">
                    <!-- Notch -->
            ...
            <div class="lg:col-span-7 order-1 lg:order-2 space-y-6 text-left">
                ...
                <div class="pt-4 flex items-center gap-3">
                    <a href="#" class="inline-flex items-center gap-2 text-xs font-bold text-emerald-600 hover:underline">
