<x-marketing-layout>
    ...
    <section class="pt-20 pb-12 text-center relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-6 space-y-6">
            <span class="text-xs font-bold text-emerald-500 uppercase tracking-widest block">FEATURE CATALOGUE</span>
            ...
            <p class="text-xs sm:text-sm text-slate-550 max-w-xl mx-auto leading-relaxed">
    ...
    <section x-data="{ activeTab: 'all' }" class="pb-24">
        ...
        <div class="max-w-7xl mx-auto px-6 mb-12 flex justify-center">
            <div class="inline-flex flex-wrap items-center gap-1.5 p-1.5 bg-slate-100 rounded-2xl border border-slate-200/50 shadow-inner">
                <button 
                    @click="activeTab = 'all'" 
                    :class="activeTab === 'all' ? 'bg-white text-slate-900 shadow-sm font-bold' : 'text-slate-500 hover:text-slate-900 font-medium'"
                ...
                <button 
                    ...
                    :class="activeTab === 'operations' ? 'bg-white text-slate-900 shadow-sm font-bold' : 'text-slate-500 hover:text-slate-900 font-medium'"
                    class="px-6 py-2 rounded-xl text-xs uppercase tracking-wider transition-all duration-200 focus:outline-none"
                >
                    Operations
                </button>
                <button 
                    ...
                    :class="activeTab === 'finance' ? 'bg-white text-slate-900 shadow-sm font-bold' : 'text-slate-500 hover:text-slate-900 font-medium'"
                    class="px-6 py-2 rounded-xl text-xs uppercase tracking-wider transition-all duration-200 focus:outline-none"
                >
                    Finance & Growth
                </button>
                <button 
                    ...
                    :class="activeTab === 'management' ? 'bg-white text-slate-900 shadow-sm font-bold' : 'text-slate-500 hover:text-slate-900 font-medium'"
                    class="px-6 py-2 rounded-xl text-xs uppercase tracking-wider transition-all duration-200 focus:outline-none"
                >
                    Management & Apps
                </button>
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div 
                ...
                class="bg-white border border-slate-200 rounded-3xl p-8 hover:border-slate-350 hover:shadow-md transition duration-300 flex flex-col justify-between"
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 01</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Turf Profile & Listing</h3>
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 02</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Smart Slot Management</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 03</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Booking Management</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 04</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Payment Integration</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 05</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Cancellation & Refunds</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 06</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Staff & Manager Portal</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 07</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Coupons & Discounts</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 08</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Reviews & Ratings</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 09</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Location & Discovery</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 10</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Push Notifications</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 11</span>
                    </div>
                    <div class="space-y-2 text-left">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 12</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Slot Lock / Hold</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 13</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Support Messages</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 14</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Mobile-First Customer App</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
            ...
            >
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-[10px] font-black text-slate-400 uppercase tracking-wider bg-slate-100 px-2.5 py-1 rounded-lg">Module 15</span>
                    </div>
                    <div class="space-y-2 text-left">
                        <h3 class="text-base font-bold text-slate-900">Multi-Sport Support</h3>
                        <p class="text-xs text-slate-500 leading-relaxed">
    ...
    <section class="py-20 text-center max-w-4xl mx-auto px-6 space-y-6">
        <h2 class="text-3xl font-black text-slate-900">Ready to digitalize your sports venue?</h2>
