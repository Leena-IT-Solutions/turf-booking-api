...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-sans bg-gray-50 text-gray-800 min-h-screen flex flex-col justify-between selection:bg-emerald-500 selection:text-white">
        ...
        <header class="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 px-6 py-4">
            <div class="max-w-4xl mx-auto flex items-center justify-between">
                ...
                <a href="{{ url('/') }}" class="inline-flex items-center justify-center px-4 py-2 text-xs font-semibold uppercase tracking-wider text-gray-700 hover:text-emerald-500 transition">
                    &larr; Back to Home
                </a>
            </div>
        </header>
        ...
        <main class="flex-grow py-12 px-6">
            <article class="max-w-4xl mx-auto bg-white border border-gray-100 rounded-3xl p-8 sm:p-12 shadow-sm">
                
                <header class="border-b border-gray-100 pb-8 mb-8">
                    <h1 class="text-3xl font-black text-gray-900 tracking-tight">Privacy Policy</h1>
                    <p class="text-sm text-gray-400 mt-2">Last Updated: July 16, 2026</p>
                </header>

                <div class="space-y-8 text-sm leading-relaxed text-gray-600">
                    
                    <section class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900">1. Introduction</h2>
                        <p>
                    ...
                    <section class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900">2. Information We Collect</h2>
                    ...
                    <section class="space-y-3 p-6 bg-emerald-50/50 rounded-2xl border border-emerald-100/50">
                        <h2 class="text-lg font-bold text-emerald-800">3. Location Data Consent (App Store & Play Store Compliance)</h2>
                        <p>
                        ...
                        <p class="font-medium text-gray-900">Why we collect location data:</p>
                        <p class="text-xs">
                    ...
                    <section class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900">4. How We Use Your Information</h2>
                    ...
                    <section class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900">5. Account Deletion & Data Retention</h2>
                        <p>
                    ...
                    <section class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900">6. Security of Your Data</h2>
                        <p>
                    ...
                    <section class="space-y-3">
                        <h2 class="text-lg font-bold text-gray-900">7. Changes to This Privacy Policy</h2>
                        <p>
