<x-marketing-layout>
    ...
    <section x-data="{ annual: false }" class="py-20 lg:py-32 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-6 text-center space-y-6 mb-16">
            <span class="text-xs font-bold text-emerald-500 dark:text-emerald-400 uppercase tracking-widest block">MEMBERSHIPS & TIERS</span>
            ...
            <p class="text-base text-slate-600 dark:text-slate-400 max-w-xl mx-auto leading-relaxed">
            ...
            <div class="flex items-center justify-center gap-4 pt-6">
                <span :class="!annual ? 'text-slate-900 dark:text-white font-bold' : 'text-slate-400 font-medium'" class="text-xs sm:text-sm transition duration-150">Monthly Billing</span>
                
                <button 
                    @click="annual = !annual" 
                    type="button"
                    class="w-12 h-6 rounded-full bg-slate-200 dark:bg-slate-800 p-0.5 relative transition duration-300 focus:outline-none"
                >
                    <span 
                ...
                <div class="flex items-center gap-2">
                    <span :class="annual ? 'text-slate-900 dark:text-white font-bold' : 'text-slate-400 font-medium'" class="text-xs sm:text-sm transition duration-150">Annual Billing</span>
                    <span class="text-[10px] font-bold px-2 py-0.5 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-full border border-emerald-500/20">SAVE 20%</span>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch mb-24">
            ...
            <!-- Plan 1: Starter -->
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 flex flex-col justify-between hover:border-slate-350 dark:hover:border-slate-700 transition duration-300 shadow-sm relative">
                <div class="space-y-6">
                    <div>
                        <h3 class="text-lg font-bold text-slate-900 dark:text-white">Starter Plan</h3>
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Perfect for single pitch owners starting out.</p>
                    </div>
                    ...
                    <div class="flex items-baseline gap-1 text-slate-900 dark:text-white">
                        ...
                        <span class="text-xs text-slate-450 dark:text-slate-500">/ month</span>
                    </div>

                    <hr class="border-slate-200/60 dark:border-slate-800">

                    <!-- Features -->
                    <ul class="space-y-3.5 text-xs text-slate-600 dark:text-slate-400">
                ...
                <div class="pt-8">
                    <a href="{{ route('register') }}" class="w-full inline-flex items-center justify-center py-3 bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-750 font-bold rounded-xl text-xs uppercase tracking-wider transition">
                        Start Free Trial
                    </a>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-b from-slate-900 to-slate-950 dark:from-slate-900 dark:to-slate-900/60 border-2 border-emerald-500 rounded-3xl p-8 flex flex-col justify-between transition duration-300 shadow-xl relative text-white">
                <!-- Popular Badge -->
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 flex flex-col justify-between hover:border-slate-350 dark:hover:border-slate-700 transition duration-300 shadow-sm relative">
                <div class="space-y-6">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400 mt-2">Tailored for large sports centers & franchises.</p>
                    </div>
                ...
                <div class="pt-8">
                    <a href="{{ url('/contact') }}" class="w-full inline-flex items-center justify-center py-3 bg-slate-900 hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition">
                        Contact Sales
                    </a>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 mb-24 hidden md:block">
            <h2 class="text-xl font-bold text-slate-900 dark:text-white mb-8">Compare Plan Details</h2>
            <div class="overflow-hidden border border-slate-200 dark:border-slate-800 rounded-2xl bg-white dark:bg-slate-950">
                <table class="w-full text-left text-xs border-collapse">
                    <thead>
                        <tr class="bg-slate-50 dark:bg-slate-900 text-slate-400 font-bold uppercase tracking-wider text-[10px]">
                            <th class="p-4 border-b border-slate-200 dark:border-slate-800">Core Capabilities</th>
                            <th class="p-4 border-b border-slate-200 dark:border-slate-800">Starter</th>
                            <th class="p-4 border-b border-slate-200 dark:border-slate-800">Growth</th>
                            <th class="p-4 border-b border-slate-200 dark:border-slate-800">Enterprise</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-800 text-slate-600 dark:text-slate-400">
                        <tr>
                            <td class="p-4 font-bold text-slate-800 dark:text-white">Active Pitches / Fields</td>
                            <td class="p-4">1 Pitch</td>
                            <td class="p-4">Up to 5 Pitches</td>
                            <td class="p-4">Unlimited</td>
                        </tr>
                        <tr>
                            <td class="p-4 font-bold text-slate-800 dark:text-white">Staff Member Seats</td>
                            <td class="p-4">3 Staff</td>
                            <td class="p-4">10 Staff</td>
                            <td class="p-4">Unlimited</td>
                        </tr>
                        <tr>
                            <td class="p-4 font-bold text-slate-800 dark:text-white">Dynamic Pricing Settings</td>
                            <td class="p-4">Basic rules</td>
                            <td class="p-4">Full Automation</td>
                            <td class="p-4">Full Automation</td>
                        </tr>
                        <tr>
                            <td class="p-4 font-bold text-slate-800 dark:text-white">Data Export Format</td>
                            <td class="p-4">CSV only</td>
                            <td class="p-4">CSV & Excel</td>
                            <td class="p-4">CSV, Excel, PDF</td>
                        </tr>
                        <tr>
                            <td class="p-4 font-bold text-slate-800 dark:text-white">Custom domain support</td>
                            <td class="p-4">✕</td>
                            <td class="p-4">✓</td>
                            <td class="p-4">✓</td>
                        </tr>
                        <tr>
                            <td class="p-4 font-bold text-slate-800 dark:text-white">Customer Support</td>
        ...
        <div class="max-w-4xl mx-auto px-6 space-y-12">
            <div class="text-center space-y-4">
                <span class="text-xs font-bold text-emerald-500 dark:text-emerald-400 uppercase tracking-widest block">BILLING & TRANSFERS</span>
                <h2 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Pricing FAQs</h2>
            </div>
            ...
            <div class="space-y-4">
                <details class="group bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 [&_summary::-webkit-details-marker]:hidden">
                    <summary class="flex items-center justify-between cursor-pointer focus:outline-none">
                        <h3 class="text-xs sm:text-sm font-bold text-slate-900 dark:text-white">Can I change subscription plans at any time?</h3>
                        <span class="shrink-0 transition-transform duration-350 text-slate-400 group-open:-rotate-180">▼</span>
                    </summary>
                    <p class="mt-4 text-xs text-slate-550 dark:text-slate-400 leading-relaxed">
                ...
                <details class="group bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 [&_summary::-webkit-details-marker]:hidden">
                    <summary class="flex items-center justify-between cursor-pointer focus:outline-none">
                        <h3 class="text-xs sm:text-sm font-bold text-slate-900 dark:text-white">What payment options do you support?</h3>
                        <span class="shrink-0 transition-transform duration-350 text-slate-400 group-open:-rotate-180">▼</span>
                    </summary>
                    <p class="mt-4 text-xs text-slate-550 dark:text-slate-400 leading-relaxed">
                ...
                <details class="group bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 [&_summary::-webkit-details-marker]:hidden">
                    <summary class="flex items-center justify-between cursor-pointer focus:outline-none">
                        <h3 class="text-xs sm:text-sm font-bold text-slate-900 dark:text-white">Do you charge commissions on bookings processed?</h3>
                        <span class="shrink-0 transition-transform duration-350 text-slate-400 group-open:-rotate-180">▼</span>
                    </summary>
