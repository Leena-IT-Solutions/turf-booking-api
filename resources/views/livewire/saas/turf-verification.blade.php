                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition duration-200 flex flex-col justify-between relative group">
                    ...
                    <div class="mt-6 pt-4 border-t border-gray-50 flex items-center gap-2">
                        <button 
                            ...
                            class="flex-1 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-[10px] font-bold rounded-xl shadow-md shadow-indigo-500/10 hover:shadow-lg hover:shadow-indigo-500/20 transition flex items-center justify-center gap-2 cursor-pointer"
                        >
                        ...
                        <a 
                            ...
                            target="_blank" 
                            class="px-3.5 py-2.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-[10px] font-bold rounded-xl border border-emerald-200 transition flex items-center justify-center gap-1 cursor-pointer shrink-0"
                            title="{{ __('Open in new tab as turf owner') }}"
                        >
                            <span>{{ __('Access ↗') }}</span>
                        </a>
                    </div>
                ...
                @if($activeModalTurf)
                    ...
                    <div class="md:col-span-2 p-6 md:p-8 space-y-6 border-b md:border-b-0 md:border-r border-gray-200 bg-white" style="height: 100%; max-height: 100%; overflow-y: auto;">
                        ...
                        <div class="space-y-2">
                            ...
                            @endphp
                            <div class="space-y-4">
                                @forelse($groupedSlots as $categoryName => $slots)
                                    <div class="space-y-2">
                                        <!-- Category Header -->
                                        ...
                                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                            @foreach($slots as $slot)
                                                @php
                                                    $summarizedPricing = [];
                                                    $priceGroups = [];
                                                    foreach ($slot['pricing'] as $day => $price) {
                                                        $priceGroups[$price][] = $day;
                                                    }
                                                    
                                                    foreach ($priceGroups as $price => $days) {
                                                        if (count($days) === 7) {
                                                            $summarizedPricing[] = "All: ₹{$price}";
                                                        } else {
                                                    ...
                                                    $priceText = implode(' | ', $summarizedPricing);
