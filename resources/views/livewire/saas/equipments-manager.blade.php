...
new #[Layout('layouts.app')] class extends Component
{
    ...
    {
        $this->reset(['equipmentId', 'name', 'is_active']);
        $this->resetErrorBag();
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-750">
                        <thead class="bg-gray-50/55 dark:bg-gray-900/10">
                            <tr>
                                <th scope="col" class="px-6 py-4 text-left text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">{{ __('Equipment Option Name') }}</th>
