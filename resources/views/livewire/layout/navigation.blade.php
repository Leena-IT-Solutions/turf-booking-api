...
@php
    ...
    $activeClass = 'active-menu-item bg-indigo-50/80 text-indigo-650 dark:bg-indigo-500/15 dark:text-indigo-300 font-bold border-l-4 border-indigo-600 dark:border-indigo-400 rounded-l-none pl-3 shadow-xs';
    $inactiveClass = 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100';
    $activeSvgClass = 'text-indigo-600 dark:text-indigo-400';
            ...
            <nav class="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6" x-init="setTimeout(() => { $el.querySelector('.active-menu-item')?.scrollIntoView({ block: 'center', behavior: 'smooth' }) }, 150)">
                ...
                @if (auth()->user()->hasRole('saas-admin'))
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('saas.update-software') }}" wire:navigate class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition duration-150 ease-in-out {{ request()->routeIs('saas.update-software') ? $activeClass : $inactiveClass }}">
                            <svg class="h-5 w-5 text-gray-500 {{ request()->routeIs('saas.update-software') ? $activeSvgClass : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                @if (auth()->check())
                    <div class="space-y-2">
                        <div class="px-4 py-1.5 text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 tracking-widest">{{ __('General') }}</div>
            ...
            <nav class="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6" x-init="setTimeout(() => { $el.querySelector('.active-menu-item')?.scrollIntoView({ block: 'center', behavior: 'smooth' }) }, 150)">
                ...
                @if (auth()->user()->hasRole('saas-admin'))
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('saas.update-software') }}" wire:navigate @click="sidebarOpen = false" class="flex items-center px-4 py-3 text-sm font-medium rounded-xl transition duration-150 ease-in-out {{ request()->routeIs('saas.update-software') ? $activeClass : $inactiveClass }}">
                            <svg class="h-5 w-5 text-gray-500 {{ request()->routeIs('saas.update-software') ? $activeSvgClass : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 1121.21 6H16" />
                            </svg>
                            <span class="ms-3">{{ __('Update Software') }}</span>
