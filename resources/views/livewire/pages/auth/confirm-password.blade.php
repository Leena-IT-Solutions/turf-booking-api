...
<div>
    <div class="mb-6 text-center">
        <h2 class="text-xl font-extrabold text-slate-950 tracking-tight">Confirm Password</h2>
    ...
    <form wire:submit="confirmPassword" class="space-y-4">
        ...
        <div>
            ...
            <x-text-input wire:model="password"
                          id="password"
                          class="block w-full px-3.5 py-2.5 bg-slate-50/50 border-slate-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm text-sm"
                          type="password"
                          name="password"
