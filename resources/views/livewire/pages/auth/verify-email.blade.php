...
<div>
    <div class="mb-6 text-center">
        <h2 class="text-xl font-extrabold text-slate-950 tracking-tight">Verify Your Email</h2>
    ...
    @if (session('status') == 'verification-link-sent')
        <div class="mb-5 p-3.5 bg-emerald-50 border border-emerald-100 rounded-xl text-xs text-emerald-800 font-medium">
    ...
    <div class="space-y-4">
        ...
        <div class="text-center">
            <button wire:click="logout" type="button" class="text-xs font-bold text-slate-500 hover:text-slate-800 transition-colors focus:outline-none focus:underline">
                {{ __('Log Out') }}
            </button>
        </div>
    </div>
