...
<div>
    ...
    <form wire:submit="register" class="space-y-4">
        ...
        <div>
            ...
            <x-text-input wire:model="name" id="name" class="block w-full px-3.5 py-2.5 bg-slate-50/50 border-slate-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm text-sm" type="text" name="name" required autofocus autocomplete="name" />
        ...
        <div>
            ...
            <x-text-input wire:model="email" id="email" class="block w-full px-3.5 py-2.5 bg-slate-50/50 border-slate-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm text-sm" type="email" name="email" required autocomplete="username" />
