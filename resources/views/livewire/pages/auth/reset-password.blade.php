...
<div>
    <div class="mb-6 text-center">
        <h2 class="text-xl font-extrabold text-slate-950 tracking-tight">Create New Password</h2>
        <p class="text-xs text-slate-500 mt-1.5">Enter your email and choose a secure new password</p>
    </div>
    ...
    <form wire:submit="resetPassword" class="space-y-4">
        ...
        <div>
            ...
            <x-text-input wire:model="email" id="email" class="block w-full px-3.5 py-2.5 bg-slate-50/50 border-slate-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm text-sm" type="email" name="email" required autofocus autocomplete="username" />
        ...
        <div>
            ...
            <x-text-input wire:model="password" id="password" class="block w-full px-3.5 py-2.5 bg-slate-50/50 border-slate-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm text-sm" type="password" name="password" required autocomplete="new-password" />
