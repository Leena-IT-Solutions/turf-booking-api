                    ...
                    <div class="p-6">
                        ...
                        <form wire:submit="uploadPhoto" class="space-y-4 mt-4">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed border-gray-300 dark:border-gray-650 rounded-2xl relative bg-gray-50/50 dark:bg-gray-900/10">
