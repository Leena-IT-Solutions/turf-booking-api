...
Route::middleware(['auth'])->group(function () {
    ...
    Volt::route('saas/payouts', 'saas.payout-manager')
        ->middleware('role:saas-admin')
        ->name('saas.payouts');
    Volt::route('saas/subscriptions', 'saas.subscription-earnings-manager')
        ->middleware('role:saas-admin')
        ->name('saas.subscriptions');
    Volt::route('saas/commissions', 'saas.commission-manager')
        ->middleware('role:saas-admin')
        ->name('saas.commissions');
    ...
    Volt::route('turf/bookings', 'turf.booking-manager')
        ->middleware('role:turf-admin|manager|admin')
        ->name('turf.bookings');
    Volt::route('turf/cancellations', 'turf.cancellation-manager')
        ->middleware('role:turf-admin|manager|admin')
        ->name('turf.cancellations');
    ...
    Volt::route('turf/coupons', 'turf.coupons-manager')
        ->middleware('role:turf-admin|manager|admin')
        ->name('turf.coupons');
    Volt::route('turf/taxation', 'turf.taxation-manager')
        ->middleware('role:turf-admin|manager|admin')
        ->name('turf.taxation');
